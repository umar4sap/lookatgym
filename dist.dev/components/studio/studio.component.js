    (function () {
        ...
        studioController.$inject = ['$scope', '$state', 'authService', '$mdDialog','$location', '$http', '$q', '$mdToast', 'moment', '$filter','zoneService'];

        function studioController($scope, $state, authService, $mdDialog,$location, $http, $q, $mdToast, moment, $filter,zoneService) {
            var vm = this;
